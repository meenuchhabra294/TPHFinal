...
dataset1=dataset.loc[:,["RP_power","Ball_Mill","RP_Bin_Level","Clinker","BM_Frate","SFbyS","PA_prop","S_ByDamper","TPH"]]
...
print(model.predict([[2200,2150,88,0.61,210,3.8,0.02,67]]))
